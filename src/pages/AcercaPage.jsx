...
export default function AcercaPage() {
  return (
    <div className="acerca-section">
      {/* Fondo animado */}
      <div className="acerca-background">
        <div className="acerca-glow acerca-glow-1"></div>
        <div className="acerca-glow acerca-glow-2"></div>
      </div>

      <div className="container acerca-content">
        {/* Hero */}
        <div className="acerca-hero">
          <div className="row">
            <div className="col-lg-8 mx-auto text-center">
              <h1 className="acerca-title">Acerca de SIGA</h1>
        ...
        <div className="row g-4 mb-5">
          <div className="col-md-6">
            <div className="acerca-card-glass">
              <div className="acerca-card-icon">
                <Target size={48} weight="fill" className="text-primario" />
              </div>
          ...
          <div className="col-md-6">
            <div className="acerca-card-glass">
              <div className="acerca-card-icon">
                <Eye size={48} weight="fill" className="text-primario" />
              </div>
              <h2 className="h4 fw-bold text-primario mb-3">Nuestra Visión</h2>
              <p className="text-muted mb-0">
        ...
        <div className="row mb-5">
          <div className="col-lg-10 mx-auto">
            <div className="acerca-main-card">
        ...
        <div className="row">
          <div className="col-lg-8 mx-auto">
            <div className="acerca-cta-card">
              <div className="acerca-cta-content text-center">
